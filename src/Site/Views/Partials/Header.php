...
<div class="title-bar" data-responsive-toggle="realEstateMenu" data-hide-for="small" data-responsivetoggle="rtf3mv-responsivetoggle" style="display: block;">
<button class="menu-icon" type="button" data-toggle=""></button>
<div class="title-bar-title">Menu</div>
</div>
<div class="top-bar" id="realEstateMenu" style="display: none;">
<div class="top-bar-left">
<ul class="menu accordion-menu" data-responsive-menu="accordion" role="tablist" aria-multiselectable="true" data-accordionmenu="o25jyx-accordionmenu" data-responsivemenu="iwedk7-responsivemenu">
<li class="menu-text" role="menuitem">Interplanetary</li>
